    ...
    def readDoc(self):
        ...
        while os.path.exists(txt) ==False:
            ...
            with open('Cookies.txt', 'a+', encoding='utf-8') as f:
                key = input('请将cookie值复制到此处：')
                f.writelines(f'{key}\n')
                print('Cookie写入成功！')
            SetCookie.readDoc(object)
        else:
